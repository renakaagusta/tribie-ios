    ...
    public func fetchTransactionExpensesList(){
        do {
            self.transactionExpensesList = [
                TransactionExpenses(id: "0", itemId: "0", transactionId: "0", tripMemberId: "0", quantity: 2, createdAt: Date(), updatedAt: Date()),
                TransactionExpenses(id: "1", itemId: "1", transactionId: "1", tripMemberId: "1", quantity: 4, createdAt: Date(), updatedAt: Date()),
                TransactionExpenses(id: "2", itemId: "2", transactionId: "3", tripMemberId: "2", quantity: 5, createdAt: Date(), updatedAt: Date()),
            ]
            if (transactionItemList.count != 0) {
                self.state = AppState.Exist
            } else {
